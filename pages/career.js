    ...
    <section className="universitiesSection">
        <div className="container">
            <div className="universitiesCont">
                ...
                <div className="universitiesGridCont fourGrid">
                    <div className="processStepGrid">
                        <div className="prcStpIn">
                            <span className="stepNum">Design</span>
                            <h5>UI/UX Designer</h5>
                            <p className="subLoctn"><img className="img-fluid" src="/assets/mapIc.svg" />Gurugram, Haryana, India
                            </p>
                            <div className="divider"></div>
                            <p>We believe with right exposure you can do wonders for yourself and your family hence we
